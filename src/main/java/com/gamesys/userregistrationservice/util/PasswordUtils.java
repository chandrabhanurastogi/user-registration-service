package com.gamesys.userregistrationservice.util;
...
public class PasswordUtils {
    ...
    public static boolean verifyUserPassword(char [] providedPassword,
                                             char [] securedPassword, String salt)
    {
        ...
        returnValue = newSecurePassword.equalsIgnoreCase(String.valueOf(securedPassword));
